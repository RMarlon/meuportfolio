...
export const listSkills: Abilites[] = [
    {
        skills: ['Minhas', 'habilidades'],
        html:['assets/html.svg', 'HTML 5', ' HTML (Linguagem de Marcação de HiperTexto) é o bloco de construção mais básico da web. Define o significado e a estrutura do conteúdo da web...', 'Doc...', 'https://developer.mozilla.org/pt-BR/docs/Web/HTML'],
        css:['assets/css.svg', 'CSS 3', 'CSS (Cascading Style Sheets ou Folhas de Estilo em Cascata) é uma linguagem de estilo usada para descrever a apresentação de um documento escrito em HTML ou em XML...', 'Doc...', 'https://developer.mozilla.org/pt-BR/docs/Web/CSS'],
        ...
        react:['assets/react.svg', 'React TSX', ' React é uma biblioteca. Ele permite que você coloque componentes juntos, mas não prescreve como fazer roteamento e busca de dados....', 'Doc...', 'https://react.dev/learn'],
    }
];