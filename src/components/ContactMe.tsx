            ...
            {contact.map(item => (
                <div>
                    <div className="flex justify-around py-20">
                        ...
                        <form action="#" className="bg-gray-950 p-10 rounded-md shadow shadow-[#410085]">
                            ...
                            <textarea name="" id="" placeholder="Fale mais sobre sua ideia" className="w-full border border-gray-600 mr-4 mb-4 py-2 px-1 focus:outline-none hover:border-[#410085] duration-200 ease-in-out rounded-md"></textarea>
                            <div className="">
