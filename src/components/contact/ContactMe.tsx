                ...
                <div>
                    <div className="flex flex-col items-center lg:flex-row lg:justify-around py-20">
                        ...
                        <form action="#" className="bg-gray-950 p-10 mt-10 text-center lg:mt-0 lg:text-justify rounded-md shadow shadow-[#410085]">
                            <input type="text" placeholder="Digite seu nome" className="text-white border-b border-gray-600 mr-4 mb-4 py-2 text-center focus:outline-none hover:border-[#410085] duration-200 ease-in-out" />
                            <input type="email" placeholder="Digite seu e-mail" className="text-white border-b border-gray-600 mr-4 mb-4 py-2 text-center focus:outline-none hover:border-[#410085] duration-200 ease-in-out" />
                            <div className="">
                                <input type="tel" placeholder="Informe seu whatsapp" className="text-white border-b border-gray-600 mr-4 mb-4 py-2 text-center focus:outline-none hover:border-[#410085] duration-200 ease-in-out" />
                                <input type="text" placeholder="Sistema que deseja criar ?" className="text-white border-b border-gray-600 mr-4 mb-4 py-2 text-center focus:outline-none hover:border-[#410085] duration-200 ease-in-out" />
                            </div>
                            <textarea name="" id="" placeholder="Fale mais sobre sua ideia" className="text-white w-full border border-gray-600 mr-4 mb-4 py-2 px-1 mt-4 lg:mt-0 focus:outline-none hover:border-[#410085] duration-200 ease-in-out rounded-md"></textarea>
                            <div className="">
